  ...
  return (
    <div className="mt-[26px] flex justify-center">
      <div className="container-xs flex items-start justify-between gap-5 md:px-5 sm:flex-col">
        <a href="https://www.youtube.com/embed/bv8rXk8SZ7I" target="_blank">
          <div className="relative h-[120px] w-[22%] self-center border border-solid border-white-a700_01 sm:w-full">
            <Heading
              size="headingxl"
              as="h1"
        ...
        <Button
          shape="round"
          className="mt-4 min-w-[170px] rounded-[10px] border-4 px-7 font-medium sm:px-5"
        >
          Login
        </Button>
      </div>
